...
class ChecklistItemsControllerTest < ActionController::TestCase
  ...
  test "should create checklist_item" do
    assert_difference('ChecklistItem.count') do
      post :create, checklist_item: { checklist_group_id: @checklist_item.checklist_group_id, helper: @checklist_item.helper, label: @checklist_item.label, type: @checklist_item.type }
    end
  ...
  test "should update checklist_item" do
    put :update, id: @checklist_item, checklist_item: { checklist_group_id: @checklist_item.checklist_group_id, helper: @checklist_item.helper, label: @checklist_item.label, type: @checklist_item.type }
    assert_redirected_to checklist_item_path(assigns(:checklist_item))
  end
